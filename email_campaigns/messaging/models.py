...
class Camping(models.Model):
    ...
    operator_code_filter = models.CharField(max_length=3, blank=True, null=True, verbose_name="Operator Code")
    tag_filter = models.CharField(max_length=255, blank=True, null=True, verbose_name="Tag")
